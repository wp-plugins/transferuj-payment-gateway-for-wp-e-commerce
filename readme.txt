...
Accept payments from all major polish banks directly on your WP - ecommerce site via Transferuj.pl polish payment gateway system.
...
Aby korzystać z płatności Transferuj.pl w platformie WP eCommerce  niezbędne jest:
a)	Posiadanie konta w systemie Transferuj.pl
b)	Aktywna wtyczka WP eCommerce  dla Wordpressa. 
c)	Pobranie plików instalacyjnych modułu z katalogu Wordpress:



= INSTALACJA MODUŁU =
-  Instalacja automatyczna 
a)	Przejdź do „Wtyczki” następnie „Dodaj nową” i w miejscu „Szukaj wtyczek”  wyszukaj „Transferuj WP eCommerce”
...
1.	Przejdź do panelu administracyjnego i otwórz zakładkę „Wtyczki”. Kliknij „Włącz” przy pozycji „Transferuj Payment Gateway for WP e-Commerce ”.
...
Teraz należy włączyć moduł Transferuj zaznaczając dostępne  przy nazwie pole oraz dokonać odpowiednich ustawień dla modułu płatności   wybierając opcję „Ustawienia”:
 

Poniżej znajdują się Ustawienia dla modułu Transferuj.pl. Jeśli nie posiadasz konta w systemie Transferuj.pl możesz je zarejestrować klikając w odnośnik „Zarejestruj konto w systemie Transferuj.pl”.

a. Wyświetlana nazwa – należy wpisać Transferuj.pl
b. ID Sprzedawcy – jest to ID nadane Sprzedawcy podczas rejestracji konta w systemie Transferuj.pl, służy jako login podczas logowania do Panelu Odbiorcy Płatności w systemie Transferuj.pl
c. Kod bezpieczeństwa – kod, który jest dostępny w Panelu Odbiorcy Płatności w systemie Transferuj.pl w zakładce „Ustawienia” -> „Powiadomienia” sekcja „Bezpieczeństwo”. 
...
Moduł był testowany na systemie zbudowanym z wersji WP eCommerce  3.9.1 i Wordpress 4.1.
